...
// Sample mock data using your exact payload structure
const INITIAL_TEACHERS = [
    {
        ...
        bloodGroup: 'O+',
        address: 'fgdsfg',
        educationLevel: 'M.Sc in Physics',
        subjectForJoin: 'Physics',
        joinDate: '2026-07-13',
        imageUrl: 'https://i.ibb.co/sample-image.jpg', // Replace with dynamic ImgBB link
    },
    {
        _id: '2',
        ...
        motherName: 'Clara Jenkins',
        phone: '+1 (880) 122-334',
        bloodGroup: 'A+',
        address: 'Downtown, NY',
        educationLevel: 'B.Sc in Mathematics',
        subjectForJoin: 'Mathematics',
        joinDate: '2025-01-10',
        imageUrl: '', // Testing fallback image
    },
];
...
export default function TeacherTableFrontend() {
    ...
    const handleUpdate = (teacher) => {
        console.log('Update Teacher Payload:', teacher);
