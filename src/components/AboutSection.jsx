        ...
        <section id="about" className="bg-slate-50 py-16 sm:py-20">
            <div className="mx-auto grid max-w-7xl gap-12 px-6 md:px-8 lg:grid-cols-[1.2fr_0.8fr] lg:items-center">
                <div className="space-y-6 text-justify">
                    ...
                    <h2 className="text-3xl font-semibold leading-tight text-slate-800 sm:text-4xl">শিক্ষার্থী, শিক্ষক ও প্রশাসকদের জন্য সমন্বিত ও কেন্দ্রীভূত বিদ্যালয় ব্যবস্থাপনা ব্যবস্থা।</h2>
                    ...
                    <div className="space-y-4 rounded-[2rem] border border-slate-200 bg-white p-6 shadow-sm transition duration-300 hover:-translate-y-1 hover:shadow-lg sm:p-8">
